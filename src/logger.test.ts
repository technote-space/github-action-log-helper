...
describe('Logger', () => {
  ...
  describe('log', () => {
    it('should output log', () => {
      ...
      stdoutCalledWith(mockStdout, ['test1', 'test2']);
    });

    it('should output new line', () => {
      const mockStdout = spyOnStdout();
  ...
  describe('startProcess', () => {
    it('should output process', () => {
      ...
      logger.startProcess('test1');
      logger.startProcess('test2');

      stdoutCalledWith(mockStdout, ['::group::test1', '::endgroup::', '::group::test2']);
    });
  });

  describe('getColorString', () => {
    it('should return color string', () => {
      expect(logger.getColorString('Hello World!!!', {
        color: 'blue',
        backColor: 'red',
        attribute: 'bold',
      ...
      expect(logger.c('Hello World!!!', {
        color: 'yellow',
        attribute: 'underline',
      })).toBe('\x1b[33;40;4mHello World!!!\x1b[0m');
    });
  });
});
